...
#ITO66T_Ctrl_IFNγ_Hi_vs_ITO66T_IFNγ_Lo_A_lfc, y= ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_B_lfc

filtered %>%
  write.csv("Supplementary_Table_1.csv")
```
...
```{r}
#make a list of top hits for a heatmap
filtered_3 <-
filtered_2 %>%
  filter(HT29_wt_IFNg_vs_ctrl_average_neg.rank < 30 | HT29_wt_IFNg_vs_ctrl_average_pos.rank < 30 & 
           SKMEL2_wt_IFNg_vs_ctrl_average_neg.rank < 30 | SKMEL2_wt_IFNg_vs_ctrl_average_pos.rank <30 &
           A375_wt_IFNg_vs_ctrl_average_neg.rank < 30 | A375_wt_IFNg_vs_ctrl_average_pos.rank < 30 &
           SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average_neg.rank < 30 | SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average_pos.rank < 30 &
           CRC_9_CTRL_TNFa_A_B_vs_CRC_9_TNFa_A_B_rank < 30  &
           CRC_9_Ctrl_TCells_A_B_vs_CRC_9_TCells_A_B_rank < 30 &
           CRC_9_Ctrl_IFNg_Hi_Lo_vs_CRC_9_IFNg_Lo_A_B_rank < 30)
