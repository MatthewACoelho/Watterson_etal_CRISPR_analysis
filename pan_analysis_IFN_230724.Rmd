...
ggsave(plot = plot2, "SKMEL2_JAK2KO_beta_volcano.eps", width = 7.5, height = 4.5, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Minlib_SL_JAK1_JAK2_Cas9_Watterson/figures_export")
...
ggsave(plot = plot5, "SKMEL2_JAK1KO_beta_volcano.eps", width = 7.5, height = 4.5, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Minlib_SL_JAK1_JAK2_Cas9_Watterson/figures_export")
...
SKMEL_BETA_JAK1c1 <-
  ...
  dplyr::rename(SKMEL2_wt_IFNb_vs_JAK1B8_IFNb_average = neg.lfc) %>%
  select(SKMEL2_wt_IFNb_vs_JAK1B8_IFNb_average, gene)

SKMEL_BETA_JAK1c2 <-
  IFNb_average %>%
  filter(sample == "SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average") %>%
  dplyr::rename(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average = neg.lfc) %>%
  ...
  select(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average, SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average_fdr, SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average_neg_log_10_p, gene)

SKMEL_GAMMA_JAK1c1 <- 
  IFNg_average %>%
  filter(sample == "SKMEL2_wt_IFNg_vs_JAK1B8_IFNg_average") %>% 
  dplyr::rename(SKMEL2_wt_IFNg_vs_JAK1B8_IFNg_average = neg.lfc) %>%
  select(SKMEL2_wt_IFNg_vs_JAK1B8_IFNg_average, gene)

SKMEL_GAMMA_JAK1c2 <- 
  IFNg_average %>%
  filter(sample == "SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average") %>% 
  dplyr::rename(SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average = neg.lfc) %>%
  ...
  select(SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average, SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average_fdr, SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average_neg_log_10_p, gene)
...
plot1 <- ggplot(BETA, aes(x=SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average, y= SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average, size = fdr, colour = neg_log_10_p)) +
...
```{r}
# find genes shared and private to Beta and Gamma in SKMEL2
#shared res
BETA %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average >2 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average >2)
#private res beta
BETA %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average >3 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average <2)
#private res gamma
BETA %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average <1 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average >2)
...
#private sens gamma
BETA %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average > -1 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average < -3)
```
...
BETA %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average > 2 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average > 2) %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average_neg_log_10_p > 1.301029996 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average_neg_log_10_p > 1.301029996) %>%
  filter(fdr < 0.1)
...
BETA %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average > 2 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average < 1) %>%
  filter(SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average_neg_log_10_p > 1.301029996 & SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average_neg_log_10_p < 1.301029996) %>%
  filter(fdr < 0.1)

BETA %>%
  filter(SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average > 2 & SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average < 1) %>%
  filter(SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average > 1.301029996 & SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average < 1.301029996) %>%
  filter(fdr < 0.1)
...
BETA %>%
  filter(SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average < -2 & SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average > -1) %>%
  filter(SKMEL2_wt_IFNg_vs_JAK1C8_IFNg_average_neg_log_10_p > 1.301029996 & SKMEL2_wt_IFNb_vs_JAK1C8_IFNb_average_neg_log_10_p < 1.301029996) 
...
HT29_GAMMA <- 
 ...
 mutate(neg_log_10_p = (-1*log10(pvalue))) %>%
  ...
  select(gene, HT29_wt_IFNg_vs_ctrl_average_lfc, HT29_wt_IFNg_vs_ctrl_average_neg_log_10_p, HT29_wt_IFNg_vs_ctrl_average_fdr)
...
A375_GAMMA <- 
 ...
 mutate(neg_log_10_p = (-1*log10(pvalue))) %>%
  ...
  select(gene, A375_wt_IFNg_vs_ctrl_average_lfc, A375_wt_IFNg_vs_ctrl_average_neg_log_10_p, A375_wt_IFNg_vs_ctrl_average_fdr)
...
SKMEL2_GAMMA <- 
 ...
 mutate(neg_log_10_p = (-1*log10(pvalue))) %>%
  ...
  select(gene, SKMEL2_wt_IFNg_vs_ctrl_average_lfc, SKMEL2_wt_IFNg_vs_ctrl_average_neg_log_10_p, SKMEL2_wt_IFNg_vs_ctrl_average_fdr)
...
#res
GAMMA %>%
  filter(HT29_wt_IFNg_vs_ctrl_average_lfc > 1 & HT29_wt_IFNg_vs_ctrl_average_neg_log_10_p > 1.301029996) %>%
  filter(A375_wt_IFNg_vs_ctrl_average_lfc > 1 & A375_wt_IFNg_vs_ctrl_average_neg_log_10_p > 1.301029996)
#sens
GAMMA %>%
  filter(HT29_wt_IFNg_vs_ctrl_average_lfc < -1 & HT29_wt_IFNg_vs_ctrl_average_neg_log_10_p > 1.301029996) %>%
  filter(A375_wt_IFNg_vs_ctrl_average_lfc < -1 & A375_wt_IFNg_vs_ctrl_average_neg_log_10_p > 1.301029996)
...
#res
GAMMA %>%
  filter(SKMEL2_wt_IFNg_vs_ctrl_average_lfc > 1 & SKMEL2_wt_IFNg_vs_ctrl_average_neg_log_10_p > 1.301029996) %>%
  filter(A375_wt_IFNg_vs_ctrl_average_lfc > 1 & A375_wt_IFNg_vs_ctrl_average_neg_log_10_p > 1.301029996)
#sens
GAMMA %>%
  filter(SKMEL2_wt_IFNg_vs_ctrl_average_lfc < -1 & SKMEL2_wt_IFNg_vs_ctrl_average_neg_log_10_p > 1.301029996) %>%
...
semi_join(A375_SKMEL2_res, A375_HT29_res)
semi_join(HT29_SKMEL2_res, A375_HT29_res)

semi_join(A375_SKMEL2_res, A375_SKMEL2_HT29_res)
...
"HT29_wt_IFNg_vs_JAK2A11_IFNg_average_gRNA",
"HT29_wt_IFNg_vs_JAK2F4_IFNg_average_gRNA",
"HT29_wt_IFNg_vs_ctrl_average_gRNA"))

plot1 <- ggplot(IFNg_average_gRNA, aes(x=LFC)) +
theme_classic() +
labs(title= "HT29 gRNAs IFNg vs Control \nCRISPR/Cas9 KO IO") +
...
ORG_screens <- as_tibble(read.csv("ORG_MAGeCK_GP_060125.csv", stringsAsFactors = FALSE, header = TRUE))
ORG_screens_average <- as_tibble(read.csv("ORG_MAGeCK_GP_average_060125.csv", stringsAsFactors = FALSE, header = TRUE))
...
# rep A vs B IFNg low
plot6 <- ggplot(ORG_screens, aes(x=ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_lfc, y= ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_B_lfc, colour = ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_neglog10Pval)) +
geom_pointdensity(position = pos, shape = 16) +
geom_text_repel(aes(label=ifelse(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_lfc >1.85 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_B_lfc >1.85 | ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_lfc < -2.3 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_B_lfc < -2.3 | gene %in% c("CHD1", "MAP3K7", "CDX2"), gene, "")), size=3, position=pos, max.overlaps = Inf, colour = "black") +
theme_classic(base_size = 12) +
...
# TNFa vs IFNg
plot8 <- ggplot(ORG_screens, aes(x=ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc, y= ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc, colour = ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_neglog10Pval)) +
geom_pointdensity(position = pos, shape = 16) +
geom_text_repel(aes(label=ifelse(ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc > 5 | ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc > 4 | ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc < -5 | ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc < -3 | gene %in% c("CHD1", "JAK1", "JAK2", "IFNGR1", "IFNGR2", "MAP3K7", "CDX2", "CHD2", "CDX1", "TNFRSF1A"), gene, "")), size=3, position=pos, max.overlaps = Inf, colour = "black") +
theme_classic(base_size = 12) +
...
# IFNg vs T cells
plot10 <- ggplot(ORG_screens, aes(x=ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc, y= ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc, colour = ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_neglog10Pval)) +
geom_pointdensity(position = pos, shape = 16) +
geom_text_repel(aes(label=ifelse(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc > 2.5 | ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc > 4 | ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc < -3.5 | ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc < -5 | gene %in% c("CHD1", "JAK1", "JAK2", "IFNGR1", "IFNGR2", "MAP3K7", "CDX2", "CHD2", "CDX1", "TNFRSF1A"), gene, "")), size=3, position=pos, max.overlaps = Inf, colour = "black") +
theme_classic(base_size = 12) +
...
ORG_screens_2 <-
ORG_screens %>% 
  mutate(Cytokine_hit = ifelse(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc > 0.5 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_Pval < 0.05 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr < 0.25, "IFNg_res", ifelse(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc < -0.5 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_Pval < 0.01 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr < 0.25, "IFNg_sens", ifelse(ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc > 0.5 & ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_Pval < 0.05 & ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_fdr< 0.25, "TNFa_res", ifelse(ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc < -0.5 & ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_Pval < 0.05 & ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_Pval < 0.25, "TNFa_sens", NA))))) %>%
  mutate(Cytokine_hit = ifelse(ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc > 0.5 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc > 0.5 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr < 0.25 & ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_Pval < 0.05 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_Pval < 0.05 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr < 0.25, "res_both", ifelse(ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc < -0.5 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc < -0.5 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr < 0.25 & ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_Pval < 0.05 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_Pval < 0.05 & ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr < 0.25, "sens_both", Cytokine_hit)))

# check categories for cytokine screens organoid cytokine screens hit annotations
...
ORG_screens_2 %>%
  select(gene, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_Pval, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_Pval, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_fdr, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_fdr, 
...
ORG_hits <- 
  ...
  select(gene, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_Pval, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_fdr, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_Pval, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_fdr, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_fdr, 
         ITO66T_Ctrl_TCells_B_vs_ITO66T_TCells_B_lfc, ITO66T_Ctrl_TCells_B_vs_ITO66T_TCells_B_Pval, ITO66T_Ctrl_TCells_B_vs_ITO66T_TCells_B_fdr, ITO66T_Ctrl_TCells_A_vs_ITO66T_TCells_A_lfc, ITO66T_Ctrl_TCells_A_vs_ITO66T_TCells_A_Pval, ITO66T_Ctrl_TCells_A_vs_ITO66T_TCells_A_fdr, ITO66T_Ctrl_TCells_A1_vs_ITO66T_TCells_A1_lfc, ITO66T_Ctrl_TCells_A1_vs_ITO66T_TCells_A1_Pval, ITO66T_Ctrl_TCells_A1_vs_ITO66T_TCells_A1_fdr, ITO66T_Ctrl_TCells_B1_vs_ITO66T_TCells_B1_lfc, ITO66T_Ctrl_TCells_B1_vs_ITO66T_TCells_B1_Pval, ITO66T_Ctrl_TCells_B1_vs_ITO66T_TCells_B1_fdr, Cytokine_hit) %>%
  filter(ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc > 0.5 & ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval < 0.05 | ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc < -0.5 & ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval < 0.05 | is.na(Cytokine_hit) == FALSE)
...
ORG_hits %>%
  ...
  arrange(desc(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc))
...
ORG_hits %>%
  ...
  arrange(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc)
...
ORG_screens_2 %>%
  ...
  filter(ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc < 0.5 | ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval > 0.05) %>%
    arrange(desc(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc)) %>%
   select(gene, Cytokine_hit, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc)
...
ORG_screens_2 %>%
  ...
  filter(ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc > 0.5 & ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval < 0.05) %>%
    arrange(desc(ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc)) %>%
   select(gene, Cytokine_hit, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_fdr, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc)
  
#T cells only - sens
ORG_screens_2 %>%
    filter(is.na(Cytokine_hit)) %>%
  filter(ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc < -0.5 & ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval < 0.05 & ITO66T_Ctrl_TCells_A_vs_ITO66T_TCells_A_lfc < -0.5 & ITO66T_Ctrl_TCells_B_vs_ITO66T_TCells_B_lfc < -0.5 & ITO66T_Ctrl_TCells_A1_vs_ITO66T_TCells_A1_lfc < -0.5 & ITO66T_Ctrl_TCells_B1_vs_ITO66T_TCells_B1_lfc < -0.5) %>%
    arrange(ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc) %>%
   select(gene, Cytokine_hit, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_lfc, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_fdr, ITO66T_Ctrl_TCells_A_B_vs_ITO66T_TCells_A_B_Pval, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_B_lfc, ITO66T_CTRL_TNFa_A_B_vs_ITO66T_TNFa_A_B_lfc)
...
#ORGS IFNg 
rep1 <- ORG_screens_2 %>%
  select(gene, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_lfc)

rep2 <- ORG_screens_2 %>%
  select(gene, ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_B_lfc)

rep_correlation <- left_join(rep1, rep2) %>% 
  filter(is.na(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_lfc) ==FALSE & is.na(ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_B_lfc)==FALSE )

r4 <- cor(rep_correlation$ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_A_lfc, rep_correlation$ITO66T_Ctrl_IFNγ_Lo_vs_ITO66T_IFNγ_Lo_B_lfc, method = "pearson")
